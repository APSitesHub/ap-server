...
const hostKahootsSchema = Joi.object({
  ...
  dea2kids: Joi.object({
    links: Joi.object({
      dea2kids_1: Joi.string().empty(""),
      dea2kids_2: Joi.string().empty(""),
      dea2kids_3: Joi.string().empty(""),
      dea2kids_4: Joi.string().empty(""),
      dea2kids_5: Joi.string().empty(""),
      dea2kids_6: Joi.string().empty(""),
      dea2kids_7: Joi.string().empty(""),
      dea2kids_8: Joi.string().empty(""),
      dea2kids_9: Joi.string().empty(""),
      dea2kids_10: Joi.string().empty(""),
    }),
    replace: Joi.bool().required(),
  }),
  deb1kids: Joi.object({
    links: Joi.object({
      deb1kids_1: Joi.string().empty(""),
      deb1kids_2: Joi.string().empty(""),
      deb1kids_3: Joi.string().empty(""),
      deb1kids_4: Joi.string().empty(""),
      deb1kids_5: Joi.string().empty(""),
      deb1kids_6: Joi.string().empty(""),
      deb1kids_7: Joi.string().empty(""),
      deb1kids_8: Joi.string().empty(""),
      deb1kids_9: Joi.string().empty(""),
      deb1kids_10: Joi.string().empty(""),
    }),
    replace: Joi.bool().required(),
  }),
  ...
  pla2kids: Joi.object({
    links: Joi.object({
      pla2kids_1: Joi.string().empty(""),
      pla2kids_2: Joi.string().empty(""),
      pla2kids_3: Joi.string().empty(""),
      pla2kids_4: Joi.string().empty(""),
      pla2kids_5: Joi.string().empty(""),
      pla2kids_6: Joi.string().empty(""),
      pla2kids_7: Joi.string().empty(""),
      pla2kids_8: Joi.string().empty(""),
      pla2kids_9: Joi.string().empty(""),
      pla2kids_10: Joi.string().empty(""),
    }),
    replace: Joi.bool().required(),
  }),
  ...
  apconf: Joi.object({
    links: Joi.object({
      apconf_1: Joi.string().empty(""),
      apconf_2: Joi.string().empty(""),
      apconf_3: Joi.string().empty(""),
      apconf_4: Joi.string().empty(""),
      apconf_5: Joi.string().empty(""),
    }),
    replace: Joi.bool().required(),
  }),
  kubrak: Joi.object({
  ...
  lyasota: Joi.object({
    links: Joi.object({
      lyasota_1: Joi.string().empty(""),
      lyasota_2: Joi.string().empty(""),
      lyasota_3: Joi.string().empty(""),
      lyasota_4: Joi.string().empty(""),
      lyasota_5: Joi.string().empty(""),
    }),
    replace: Joi.bool().required(),
  }),
});
